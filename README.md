...
The first author and Sergio Da Silva and Curran McConnell are preparing a new version of the package, which aims to speed up computation time and add functionality for geometric vertex decomposition allowing substitutions.
